          ...
          <div className="flex items-center justify-between p-2">
            ...
            <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl">
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all active:scale-95 ${theme === 'light' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
              >
                Light
              </button>
              <button
                onClick={() => toggleTheme('dark')}
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all active:scale-95 ${theme === 'dark' ? 'bg-slate-700 text-white shadow-sm' : 'text-slate-400 hover:text-slate-200'}`}
              >
                Dark
              </button>
            </div>
